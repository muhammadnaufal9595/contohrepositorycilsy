...
WebUI.verifyElementVisible(findTestObject('Account/Page_MAP  Midtrans/box_LOGIN'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2)

WebUI.setText(findTestObject('Login/Page_MAP  Midtrans/inputField_email'), 'mail@mail.com')
...
WebUI.verifyElementText(findTestObject('Login/Page_MAP  Midtrans/text_Invalid email or password'), 'Invalid email or password.')
