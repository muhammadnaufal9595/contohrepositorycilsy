...
WebUI.callTestCase(findTestCase('Pre Condition/001-openHomePage'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pre Condition/002-openRegistrationPage'), [:], FailureHandling.STOP_ON_FAILURE)
