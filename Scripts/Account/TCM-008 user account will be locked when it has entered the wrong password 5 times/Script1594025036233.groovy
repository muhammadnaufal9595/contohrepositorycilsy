...
WebUI.setText(findTestObject('Login/Page_MAP  Midtrans/inputField_password'), 'asdajhsbje')
...
WebUI.verifyElementVisible(findTestObject('Login/Page_MAP  Midtrans/text_Invalid email or password'))
...
WebUI.setText(findTestObject('Login/Page_MAP  Midtrans/inputField_password'), 'asdsadhjajs')
...
WebUI.setText(findTestObject('Login/Page_MAP  Midtrans/inputField_password'), 'asdajsdasda')
...
WebUI.setText(findTestObject('Login/Page_MAP  Midtrans/inputField_password'), 'xsajhdbajds')
...
WebUI.setText(findTestObject('Login/Page_MAP  Midtrans/inputField_password'), 'rhjsbhsakd')
...
WebUI.verifyElementVisible(findTestObject('Account/Page_MAP  Midtrans/box_Your account is locked'))
